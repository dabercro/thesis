...
\begin{figure}
  \centering
  \includegraphics[width=0.65\linewidth]{figures/210211_STXS_VZ_XbbVZ_decorr12345_skip_513dc9b8_inclusive_gof/Gof_inclusive_.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_2_13TeV2017_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_2_13TeV2017_postfit} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_3_13TeV2017_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_3_13TeV2017_postfit} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_4_13TeV2017_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_4_13TeV2017_postfit} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_1_13TeV2017_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Zmm_1_13TeV2017_postfit} \\
...
In this case, the $W$ + heavy jets control region is not shown, since the related process contributes less
...
\begin{figure}
  \centering
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_18_13TeV2018_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_18_13TeV2018_postfit} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_20_13TeV2018_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_20_13TeV2018_postfit} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_22_13TeV2018_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_22_13TeV2018_postfit} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_24_13TeV2018_prefit}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXS_VZ_unblinded_XbbVZ_278ade89_postfitplots/plot_shapes_vhbb_Wen_24_13TeV2018_postfit} \\
...
From these post-fit distributions, the strength and uncertainty of the signal samples can be extracted.
A value of 1.0 corresponds to the expectation based on simulation of the Standard Model.
By correlating all of the signal samples across all of the STXS bins,
an inclusive signal strength can be obtained.
The likelihood scan of this strength is shown in Figure~\ref{fig:vz-inclusive}.
The maximum likelihood with respect to the Standard Model is $1.19 \pm 0.10 \mathrm{(stat)} \pm 0.10 \mathrm{(sys)}$.
The uncertainty of this measurement means the result has a p-value of 19\%, assuming Standard Model couplings,
or disagreement of only $1.3\sigma$.
Figure~\ref{fig:vz-stxs} shows the measured kinematic distributions of the various $V\!Z$ processes.
Assuming the Standard Model, the measurement has a p-value of 43\%.
Overall, the $V\!Z$ cross-check has very good agreement with the Standard Model.

\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/210303_inclVZ_unblinded_XbbVZ_644dd229_a866aef8/scan_nominal_r.pdf}
  \caption[Inclusive likelihood scan of $V\!Z$]{
    ...
    Comparing the two curves allows the systematic uncertainties to be evaluated.
  }
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/210220_STXS_VZ_unblinded_XbbVZ_fe58cdd8_a866aef8/summary_stxs.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.65\linewidth]{figures/210304_STXSfine_400split_Xbb_8f854f5a_inclusive_gof/Gof_inclusive_.pdf}
...
so the five channels cannot be considered to be entirely separate for the fit.
%
\begin{figure}
  \centering
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_14_13TeV2016_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_14_13TeV2016_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_15_13TeV2016_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_15_13TeV2016_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_21_13TeV2016_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_21_13TeV2016_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_23_13TeV2016_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Znn_23_13TeV2016_postfit.pdf} \\
...
\begin{figure}
  \centering
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_6_13TeV2017_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_6_13TeV2017_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_7_13TeV2017_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_7_13TeV2017_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_8_13TeV2017_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_8_13TeV2017_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_5_13TeV2017_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210217_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Wmn_5_13TeV2017_postfit.pdf} \\
...
\begin{figure}
  \centering
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_6_13TeV2018_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_6_13TeV2018_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_7_13TeV2018_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_7_13TeV2018_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_5_13TeV2018_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_5_13TeV2018_postfit.pdf} \\
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_9_13TeV2018_prefit.pdf}
  \includegraphics[width=0.35\linewidth]{figures/210216_STXSfine_400split_unblinded_Xbb_c2e6b2d7_postfitplots/plot_shapes_vhbb_Zee_9_13TeV2018_postfit.pdf} \\
...
The inclusive signal strength is shown in Figure~\ref{fig:vh-inclusive} to be 0.56.
The uncertainties put this measurement at $2.1\sigma$ below the Standard Model.
Figure~\ref{fig:vh-whzh} shows that this low value is caused by a low cross section measurement of $Z\!H$,
which alone is $2.8\sigma$ below the Standard Model.
...
the STXS scans have an agreement with a p-value of 9.4\%.
Standard Model kinematics cannot be entirely ruled out by this measure.

\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/210303_incl_unblinded_Xbb_6c69065c_a866aef8/scan_nominal_r.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/210302_vh_unblinded_Xbb_41a92082_a866aef8/summary_stxs.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/210302_STXSfine_400split_unblinded_Xbb_6c69065c_a866aef8/summary_stxs.pdf}
