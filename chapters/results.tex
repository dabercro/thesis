...
This data, totalling about \SI{137}{fb^{-1}} was used for the analysis.
...
Figure~\ref{fig:vz_stxs} shows the measured kinematic distributions of the various $V\!Z$ processes.
...
\begin{figure}
  ...
  \caption[Inclusive likelihood scan of $V\!Z$]{
    ...
    Comparing the two curves allows the systematic uncertainties to be evaulated.
  }
...
\begin{figure}
  \centering
  \includegraphics[width=0.65\linewidth]{figures/210207_From_Aliya_inclusive_gof/Gof_inclusive_.pdf}
