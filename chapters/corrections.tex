...
that can be understood at the threoretical level.
...
\subsection{$V$ + Jets Reweighting}

One common way to make simple Leading Order (LO) calculations more accurate
is to generate Next to Leading Order (NLO) samples and reweight the LO sample
