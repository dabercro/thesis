...
to final states of different energy. \phil{collision energy or production energy? be clear}
...
\phil{Maybe you will go into more detail, but I feel like you can add a paragraph or two to motivate why differential xs are so important and what we learn from them. Recall we did not know exactly how the Higgs boson behaved when we discovered it, there was no reasonable mass prediction at all.  } 
...
\phil{This section feels incomplete, I think you need to motivate the
  measurement more. Also you should motivate the LHC more.  Why is
  there such a device?} 