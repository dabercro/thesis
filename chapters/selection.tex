...
\begin{figure}
  \centering
  \includegraphics[width=0.7\linewidth]{figures/CompData3Years.pdf}
...
The di-jet mass is required to be less than \SI{500}{GeV}
and to satisfy $p_T > \SI{120}{GeV}$.
...
At most only one jet with $p_T > \SI{30}{GeV}$ is allowed
