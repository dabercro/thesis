...
\item There is a gap in the ECAL geometry,
  so the electron must be outisde the gap $1.4442 < |\eta| < 1.5660$.
...
Due to factors like pileup, imperfect detector response, and differences in various jet-clusterings
...
along with identified Initial State Radiation (ISR) jets,
