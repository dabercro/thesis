...
\phil{I think you should try to tie this paragraph with the above
  flow. Firstly, elude to the measuerement as being the focus of your
  thesis. Secondly, you should connect it to the SM}
...
\phil{I am confused by the paragraph below. Personally, I find
  expalanations about what I am about to read confusing and a waste of
  time, I think this paragraph doesn't fit with the flow of this
  intro to theory. } 
...
\phil{ I really like you brought in the E-L equation. However, I think
  you need to tie the text into it more. It looks like you are agoing
  to go into detail into EWSB later. I might restrcuture thsi section
  to either put less details here, and more later or more now, and
  less later.  Perhaps being a bit more abstract to start before you
  mention all teh gauge fields will do that}
...
photon. \phil{It might be good to motivate this choice either through
  a reference or actually not setting the other double to zero now,
  and showing that it needs to be zero to ensure the photon is
  massless}  
\begin{gather}
  \phi(x) = \frac{1}{\sqrt{2}}
  \left(
...
coupling to the electroweak force. \phil{ While I agree it is similar,
  I think this should be in your thesis, you are doing H=>b b, the
  mechanisms are different enough that people thought there might be 2
  Higgses}
...
\end{figure}
\phil{The above didn't render in my pdf, but maybe thats me}
...
They must be produced through interacts\phil{interactions} with stable fermions.
Since the LHC is a hadron collider,
considering the vector bosons' couplings with quarks would be most
relevant. \phil{I would rephrase left}
...
The following is the charge current vertex interaction. \phil{you are
  missing the W propagator}
\[
-i \frac{g_W}{\sqrt{2}}
\left(
\begin{matrix}
...
\phil{The above paragraph is very confusing, can you rewrite it.} 
\begin{gather}
...
color singlets are called jets. \phil{I think your definition of jets
  is a bit liberal, I would say spray from a high energy quark, high
  energy is the key here. }
...
\end{gather}
\phil{Maybe you are getting to it, but I think its important to
  discuss what is offslel and what isn't, why is the HIggs not
  offshell for example. One way around this is to write the whole ME
  for the production}
...
the vector bosons decay into quarks. \phil{decay predominantly into}
...
There are three generations of leptons. \phil{This paragraph feels out
  of place, I think you said most of this, can you push this up to
  earlier}
...
making its measurement even more complicated.\phil{I would also
  mention their are neutrino decays here too}
...
has the same symmetries as $\phi$. \phil{ I think you should put this
  part earlier when you discuss the Higgs mechanism in vector bosons,
  also, you should put a decay table or plot of decays so its clear
  why bb is important}
...
\phil{This section is a bit jumbled, I think it needs some
  reorganization of the material, you mostly cover everything needed
  to explain the process but it is a bit hard to follow.  Lastly, you
  SHOULD add a new sub section here about why it is important to
  measure VHbb, what do we learn about the Higgs? Is there anything
  interesting about the kinematic dependence? Are there other
  alternate Higgs theories. Point is you should explain why this
  measurement is so imporant. }