...
This layer is \SI{61}{mm} on the layer immediately next to the ECAL and
...
The HCAL performance also degrades as it is exposed to radiation,
like the ECAL in Section~\ref{sec:ecal}.
