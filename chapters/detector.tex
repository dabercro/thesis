...
The $b$ quarks also hadronize \phil{to} form color singlets well before reaching the detector,
...
$V_{cb}$ and $V_{ub}$ are small. \phil{wonder if you want to put thi
  sin the theory section, also good to mention why b-quarks don't
  decay into tops + stuff}
...
that the detector cannot detect. \phil{split this paragraph into two,
  MET deserves its own paragraph, rework some of the explanation}
...
with additional space covered by calorimetry. \phil{Why just pixel?
  where are the strips? I spent 2 years of my life plugging in power
  cables to the strips and now they are forgotten :(}
...
The two calorimeters are destructive because \phil{they} absorb the particles that interact with them
...
magnet. \phil{This is a weird sentence for a non-expert}
...
silicon strip detectors are used. \phil{finally strips, I would rework above}
...
which are dispersed in electromagnetic showers. \phil{I think you need
  a qualifer in the first sentence. Unlike the ecal, which..., the Hcal}
...
\cite{Sirunyan_2017}. \phil{This better be in your own words.}
...
Luckily, most collisions result in uninteresting data. \phil{You
  should use an euphemism for uniteresting}
...
Each process will looks slightly different in our signal
selection. \phil{will looks=>looks}
...
showering calculation. \phil{FKS needs a citation}
...
Since the data is event-based, they are stored in n-tuple
format. \phil{put a reference or describe what an n-tuple is. N-tuple
  is a bit jargony}
These n-tuples are created and read by the CMS Software (CMSSW) \cite{INNOCENTE200131}.

\phil{This section is overall good, its better towards the end, don't
  think I have any major comments about what is missing. I am glad you
  put your work in the appendix, otherwise, I would have made a
  comment about putting your work in this part of your thesis.} 